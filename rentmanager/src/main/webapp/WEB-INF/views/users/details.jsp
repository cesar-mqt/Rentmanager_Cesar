					...
					<div class="col-md-3">
						...
						<div class="box box-primary">
							<div class="box-body box-profile">
								<h3 class="profile-username text-center">${clients.nom}
									${clients.prenom} ${clients.email}</h3>
								<ul class="list-group list-group-unbordered">
									<li class="list-group-item"><b>Reservation(s)</b> <a
										class="pull-right">${compteReservations}</a></li>
									<li class="list-group-item"><b>Voiture(s)</b> <a
										class="pull-right">${compteVoitures}</a></li>
								</ul>
							</div>
							<!-- /.box-body -->
						</div>
